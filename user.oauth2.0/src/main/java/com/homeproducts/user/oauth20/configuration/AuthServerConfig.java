package com.homeproducts.user.oauth20.configuration;
...
public class AuthServerConfig extends AuthorizationServerConfigurerAdapter {
    @Value("${security.oauth2.client.clinet-id}")
    private String clientId;

    @Value("${security.oauth2.client.clinet-secret}")
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients
                .inMemory()
                .withClient(clientId)
                .secret(new BCryptPasswordEncoder(12).encode(clineSecret))
                .scopes("read", "write")
